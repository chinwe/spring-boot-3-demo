...
/**
 * Orika OrderItem 映射器 - MapStruct 实现
 *
 * 功能特性：
 * 1. OrderItem -> OrderItemDto 映射
 * 2. OrderItemDto -> OrderItem 反向映射
 * 3. 自定义格式化方法
 *
 * @author chinwe
 */
@Mapper(componentModel = "spring")
public interface OrikaOrderItemMapper {

    /**
     * OrderItem -> OrderItemDto 映射
     */
